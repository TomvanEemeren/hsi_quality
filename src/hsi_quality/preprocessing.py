...
def preprocess_hyperspectral_image(nc_file: str, location: str):
    ...
    # Hypso-2 capture
    h2_l1a_nc_file = os.path.join(DATA_DIR,location,"raw",nc_file)
    ...
    os.makedirs(os.path.join(DATA_DIR,location,"processed"), exist_ok=True)

    # Save the processed data
    nc_file_new = os.path.splitext(nc_file)[0].removesuffix("-l1a")+"-l1d.nc"
    l1d_path = os.path.join(DATA_DIR,location,"processed",nc_file_new)
