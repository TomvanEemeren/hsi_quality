...
def write_l1d_nc_file(satobj, l1d_path: str = None, overwrite: bool = False, masked: bool = False, **kwargs) -> None:
    
    if l1d_path is not None:
        satobj.l1d_nc_file = l1d_path
    
    if Path(l1d_path).is_file() and not overwrite:
